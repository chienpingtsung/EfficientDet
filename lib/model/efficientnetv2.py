...
class EfficientNetV2(nn.Module):
    ...
    def model_args(scale):
        block_args = {'xs': {'dropout': 0.2,
                             ...
                             'scale_channels': (16, 32, 48, 112, 192)},
                      's': {'dropout': 0.2,
                            ...
                            'scale_channels': (24, 48, 64, 160, 256)},
                      'm': {'dropout': 0.3,
                            ...
                            'scale_channels': (24, 48, 80, 176, 512)},
                      'l': {'dropout': 0.4,
                            ...
                            'scale_channels': (32, 64, 96, 224, 640)},
                      'xl': {'dropout': 0.4,
                             'block': [('f', 4, 3, 1, 1, 32, 32, None),
                             ...
                             'scale_channels': (32, 64, 96, 256, 640)}}
